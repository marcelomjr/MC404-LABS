...
if [ -z "$BINUTILS_PATH" ]; then
  BINUTILS_PATH=`grep BINUTILS_PATH /home/specg12-1/mc404/simulador/deps/stage_deps/archC/etc/archc.conf | cut -d = -f2`
...
mkdir -p $TEMP_DIR
[ $? -ne 0 ] && exit $?
cp -rf /home/specg12-1/mc404/simulador/deps/stage_deps/archC/share/archc/binutils ${TEMP_DIR}/


# generate the files in the binutils tree
echo "Generating machine dependent code..."
/home/specg12-1/mc404/simulador/deps/stage_deps/archC/bin/bmdsfg $MODEL_FILE -a${ARCH_NAME}
[ $? -ne 0 ] && exit $?
...
if [ -z "$GDB_PATH" ]; then
  GDB_PATH=`grep GDB_PATH /home/specg12-1/mc404/simulador/deps/stage_deps/archC/etc/archc.conf | cut -d = -f2`
...
mkdir -p $TEMP_DIR
[ $? -ne 0 ] && exit $?
cp -rf /home/specg12-1/mc404/simulador/deps/stage_deps/archC/share/archc/gdb ${TEMP_DIR}/
